...
# (project=scitex-benchmark, owner=ywatanabe1989, repo=scitex-benchmark,
...
TMPDIR="/tmp/publish-scitex_benchmark-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-benchmark dist/* uploaded to PyPI via manual OIDC trusted publishing"
